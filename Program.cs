...
namespace GameDBServer
{
    public class Program
    {
        ...
        /// </summary>
        private static volatile Boolean NeedExitServer = false;
        ...
        private static void ConsoleInputThread(object obj)
        {
        ...
        public void InitServer()
        {
            ...
            string dbname = Global.GetSafeAttributeStr(xml, "Database", "dname");
            int maxConns = (int)Global.GetSafeAttributeLong(xml, "Database", "maxConns");
            int codePage = (int)Global.GetSafeAttributeLong(xml, "Database", "codePage"); // có thể bỏ nếu không dùng

            string connStr = $"Server={ip};Database={dbname};User Id={uname};Password={upasswd};Maximum Pool Size={maxConns};Charset=utf8mb4;";
            var builder = new MySqlConnectionStringBuilder
            {
                ...
                UserID = uname,
                Password = upasswd,
                MaximumPoolSize = (uint)maxConns,
                //CharacterSet = "utf8mb4", // hoặc "utf8" tùy hệ thống cũ
                AllowUserVariables = true, // nếu bạn cần sử dụng biến @ trong query
                SslMode = MySqlSslMode.Preferred, // bỏ SSL nếu không dùng
            };///

            _DBManger.LoadDatabase(builder, (int)Global.GetSafeAttributeLong(xml, "Database", "maxConns"),
