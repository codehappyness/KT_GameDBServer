...
namespace Server.Tools
{
    ...
    public class DataHelper
    {
        ...
        /// <summary>
        /// Chuyển đổi chuỗi được mã hóa dạng Hex thành mảng byte (không có ký tự phân cách)
        /// </summary>
        /// <param name="s"></param>
        /// <returns></returns>
        public static byte[]? HexString2Bytes(string s)
        {
            if (s.Length % 2 != 0) // Chuỗi không hợp lệ: độ dài không chia hết cho 2
            {
                return null;
            }
        ...
        /// <summary>
        /// Định dạng thông tin lỗi ngoại lệ [phiên bản console - hàm này về lý thuyết là an toàn luồng]
        /// </summary>
        ...
        public static void WriteFormatExceptionLog(Exception? e, string extMsg, bool showMsgBox, bool finalReport = false)
        {
            try
            {
                ...
                // Ghi log lỗi ngoại lệ vào file
                LogManager.WriteException(stringBuilder.ToString());
                if (showMsgBox)
                {
                    // Bật popup hiển thị log lỗi ngoại lệ
        ...
        /// <summary>
        /// Định dạng thông tin ngăn xếp lệnh (stack trace) khi xảy ra lỗi
        /// </summary>
        /// <param name="msg"></param>
        /// <returns></returns>
        public static void WriteFormatStackLog(System.Diagnostics.StackTrace stackTrace, string extMsg)
        {
            try
            {
                ...
                stringBuilder.AppendFormat("Ứng dụng đã gặp lỗi timeout khi khóa đối tượng:\r\n");

                stringBuilder.AppendFormat("\r\n Thông tin bổ sung: {0}", extMsg);
